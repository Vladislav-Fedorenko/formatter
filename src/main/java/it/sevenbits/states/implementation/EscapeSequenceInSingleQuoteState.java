...
/**
 * Class code in a state of escape sequence in single quote.
 */
public class EscapeSequenceInSingleQuoteState implements IState {
     ...
     */
    public EscapeSequenceInSingleQuoteState(final StateManager stateManager) {
