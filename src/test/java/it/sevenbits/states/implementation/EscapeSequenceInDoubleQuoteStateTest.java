...
/**
 * Tests for EscapeSequenceInDoubleQuoteState.
 */
public class EscapeSequenceInDoubleQuoteStateTest {
    ...
    @Test
    public void doubleQuoteInDoubleQuoteStateTest() throws StateException {
        state.execute(writer, '\"');
        assertEquals("wrong", "\"", writer.toString());
    }
    @Test
    public void singleQuoteInDoubleQuoteStateTest() throws StateException {
        state.execute(writer, '\'');
        assertEquals("wrong", "\'", writer.toString());
    }
